...
export default [
    Page("Theme", icons.ui.themes,
        ...
        Group("Dark Colors",
            ...
            Row({ opt: dark.secondary.bg, title: "Secondary", type: "color" }),
            Row({ opt: dark.secondary.fg, title: "On Secondary", type: "color" }),
        ),
        Group("Light Colors",
            ...
            Row({ opt: light.secondary.bg, title: "Secondary", type: "color" }),
            Row({ opt: light.secondary.fg, title: "On Secondary", type: "color" }),
        ),
        Group("Theme",
    ...
    Page("Bar", icons.ui.toolbars,
        ...
        Group("Workspaces",
            ...
            Row({ opt: b.workspaces.colorMonitors, title: "Color Workspaces according to Monitor" }),
        ),
        Group("Taskbar",
